    ...
    <main className="flex min-h-screen items-center justify-center bg-workspace px-4">
      <div className="w-full max-w-[420px]">
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <h1 className="text-[28px] font-normal text-[#202124]">Create your account</h1>
          <p className="text-sm text-[#5f6368]">Start writing with Docs</p>
        </div>
        ...
        <div className="rounded-2xl border border-[#dadce0] bg-white px-8 py-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div>
              <label htmlFor="signup-username" className="mb-1.5 block text-sm font-medium text-[#3c4043]">
                Username
              </label>
              <input
                id="signup-username"
              ...
              />
              <p className="mt-1.5 text-xs text-[#5f6368]">3–32 characters. Letters, numbers, underscores only.</p>
            </div>

            <div>
              <label htmlFor="signup-password" className="mb-1.5 block text-sm font-medium text-[#3c4043]">
                Password
              </label>
              <input
                id="signup-password"
            ...
            <div>
              <label htmlFor="signup-confirm-password" className="mb-1.5 block text-sm font-medium text-[#3c4043]">
                Confirm Password
              </label>
              <input
